...
SocketServer::SocketServer(const char * address, const char * port):sd(-1)
{
...
int SocketServer::recv(Message &obj, SocketServer * &sock)
{
    struct sockaddr sa;
...
int SocketServer::send(Message& obj, const SocketServer& sock)
{
...
std::ostream& operator<<(std::ostream& os, const SocketServer& s)
{
